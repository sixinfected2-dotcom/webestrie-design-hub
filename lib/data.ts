  ...
  clients: [
    {
      ...
      phases: [
        ...
        { id: 'G1', label: 'G.1 Politique', status: 'in-progress', desc: 'M50 — 3 sketches prêts, à implémenter' },
        { id: 'G2', label: 'G.2 Garanties', status: 'in-progress', desc: 'M60 — 3 sketches prêts, à implémenter' },
      ],
      missions: [
        {
          id: 'M60',
          ...
          status: 'in-progress',
          tag: 'Sketches prêts',
          meta: '3 sketches · À implémenter · Theme cream unifié',
          sketches: [
        ...
        },
        {
          ...
          status: 'in-progress',
          tag: 'Sketches prêts',
          meta: '3 sketches · À implémenter · 9 sections + FAQ + Contact',
          sketches: [
      ...
      pages: [
        ...
        { path: '/politique-confidentialite', name: '/politique-confidentialite', status: 'in-progress', mission: 'M50' },
        { path: '/garanties', name: '/garanties', status: 'in-progress', mission: 'M60' },
      ],
    },
  ],
  tools: [

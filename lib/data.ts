  ...
  clients: [
    {
      ...
      missions: [
        ...
        },
        {
          id: 'M72',
          num: 72,
          title: 'Header éditorial + route group (site)',
          phase: 'G3',
          status: 'live',
          tag: 'Live',
        ...
        },
        {
          id: 'M73',
          num: 73,
          title: 'Tokens + code mort + contraste AA',
          phase: 'G3',
          status: 'live',
          tag: 'Live',
          meta: 'Palette sage-editorial + terracotta rampe AA + ambre rampe AA (59 echecs→0) + 11 composants orphelins retirés + 4 constantes copie morte · 5 commits',
          commits: ['b8b7be9', '8451425', '2805900', '484495c', '5166c8c'],
          liveUrl: 'https://ctarbro.ca',
          notes: 'Tokens: palette sage-editorial déclarée dans @theme, terracotta en rampe AA (B8825A décoratif, 7A4F2D texte). Ambre en rampe AA: amber-ink (#A55900) pour texte, amber-light (#e8a838) pour fond sombre. 59 échecs de contraste → 0. Code mort: 11 composants orphelins + PageHero + ContactPageSchema + 4 imports inertes retirés. .claude/worktrees/ gitignoré.',
        },
        {
          id: 'M74',
          num: 74,
          title: 'DA 2026 « Papier & Bronze » — Accueil',
          phase: 'G3',
          status: 'live',
          tag: 'Live',
      ...
      pages: [
        { path: '/', name: 'Accueil', status: 'live', mission: 'M74' },
